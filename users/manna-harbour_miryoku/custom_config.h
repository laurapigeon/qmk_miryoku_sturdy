...
UK_PLUS,           KC_4,              KC_5,              KC_6,              UC(0xD7),          U_NA,              U_NA,              TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
KC_MINS,           KC_1,              KC_2,              KC_3,              UC(0xF7),          U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
UK_COLN,           KC_7,              KC_8,              KC_9,              TD(U_TD_U_BASE),   TD(U_TD_U_BASE),   TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    KC_ALGR,           TD(U_TD_U_BUTTON), \
...
UK_PND,            UK_PERC,           KC_LBRC,           KC_RBRC,           KC_GRV,            U_NA,              U_NA,              TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
UK_TILD,           UK_CIRC,           UK_LPRN,           UK_RPRN,           UK_ASTR,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
KC_SCLN,           UK_AMPR,           KC_SLSH,           UK_BSLS,           TD(U_TD_U_BASE),   TD(U_TD_U_BASE),   TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  KC_ALGR,           TD(U_TD_U_BUTTON), \
...
TD(U_TD_U_BUTTON), KC_ALGR,           TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  TD(U_TD_U_BASE),   TD(U_TD_U_BASE),   KC_SCRL,           KC_WH_D,           KC_WH_U,           U_NA,              \
...
TD(U_TD_U_BUTTON), KC_ALGR,           TD(U_TD_U_FUN),    TD(U_TD_U_MEDIA),  TD(U_TD_U_BASE),   TD(U_TD_U_BASE),   KC_PAUS,           U_NU,              U_NU,              U_NU,              \
