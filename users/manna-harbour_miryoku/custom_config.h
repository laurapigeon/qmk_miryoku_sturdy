...
UK_ASTR,           KC_4,              KC_5,              KC_6,              KC_SLSH,           U_NA,              U_NA,              TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
...
TD(U_TD_U_BUTTON), KC_ALGR,           TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    TD(U_TD_U_BASE),   TD(U_TD_U_BASE),   KC_HOME,           KC_PGUP,           KC_PGDN,           KC_END,            \
...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  U_NA,              U_NA,              U_PST,             U_UND,             U_CPY,             U_CUT,             U_RDO,             \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_INS,            KC_MS_L,           KC_MS_U,           KC_MS_D,           KC_MS_R,           \
TD(U_TD_U_BUTTON), KC_ALGR,           TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  TD(U_TD_U_BASE),   TD(U_TD_U_BASE),   KC_SCRL,           KC_WH_U,           KC_WH_D,           KC_PAUS,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP

#define MIRYOKU_LAYER_FUN \
UC(0xD7),          UK_PND,            UC(0x201C),        UC(0x201D),        UC(0x2661),        U_NA,              U_NA,              TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
UC(0x00B7),        UC(0x2022),        UC(0x300C),        UC(0x300D),        UC(0x2013),        U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
...
TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  U_NA,              U_NA,              KC_PSCR,           KC_WBAK,           KC_BRIU,           KC_BRID,           KC_WFWD,           \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_APP,            KC_MPRV,           KC_VOLU,           KC_VOLD,           KC_MNXT,           \
...
KC_A,              KC_S,              KC_W,              KC_D,              KC_SPC,            KC_6,              KC_LEFT,           KC_UP,             KC_DOWN,           KC_RGHT,           \
...
KC_A,              KC_S,              KC_W,              KC_D,              KC_SPC,            U_NA,              KC_LEFT,           KC_UP,             KC_DOWN,           KC_RGHT,           \
...
U_UND,             U_CUT,             U_CPY,             U_PST,             TD(U_TD_U_BASE),   TD(U_TD_U_BASE),   KC_SPC,            KC_WH_U,           KC_WH_D,           U_NA,              \
