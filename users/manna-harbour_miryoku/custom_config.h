...
UK_V,              UK_M,              UK_L,              UK_C,              UK_P,              UK_B,              UK_SLSH,           UK_U,              UK_O,              UK_Q,              \
...
UK_LBRC,           UK_4,              UK_5,              UK_6,              UK_RBRC,           U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
UK_SCLN,           UK_1,              UK_2,              UK_3,              UK_EQL,            U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
UK_GRV,            UK_7,              UK_8,              UK_9,              UK_BSLS,           U_NA,              TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    KC_ALGR,           U_NA,              \
U_NP,              U_NP,              UK_DOT,            UK_0,              UK_MINS,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
UK_LCBR,           UK_AMPR,           UK_ASTR,           UC(0xD7),          UK_RCBR,           U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
UK_COLN,           UK_DLR,            UK_PERC,           UK_CIRC,           UK_PLUS,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
UK_TILD,           UK_SLSH,           UK_AT,             UK_HASH,           UK_PIPE,           U_NA,              TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  KC_ALGR,           U_NA,              \
U_NP,              U_NP,              UK_LPRN,           UK_RPRN,           UK_UNDS,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
