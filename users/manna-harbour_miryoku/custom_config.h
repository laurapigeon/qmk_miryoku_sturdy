...
UK_COLN,           UK_7,              UK_8,              UK_9,              UK_CIRC,           U_NA,              TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    KC_ALGR,           U_NA,              \
...
UK_PND,            UK_PERC,           UK_LBRC,           UK_RBRC,           UK_GRV,            U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),     \
UK_TILD,           UK_DQUO,           UK_LPRN,           UK_RPRN,           UK_ASTR,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
UK_PIPE,           UK_AMPR,           UK_SLSH,           UK_BSLS,           UK_SCLN,           U_NA,              TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  KC_ALGR,           U_NA,              \
...
LGUI_T(UK_S),      LALT_T(UK_T),      LCTL_T(UK_R),      KC_SPC,            UK_Y,              TD(U_TD_U_BASE),   KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           \
LT(U_BUTTON,UK_X), ALGR_T(UK_K),      UK_J,              UK_G,              UK_W,              UK_Z,              UK_H,              UK_COMM,           UK_DOT,            UK_QUOT,           \
